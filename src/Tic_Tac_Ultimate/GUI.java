...
//        line.setEndX(Math.floor(stage.getWidth()/stage.getHeight())+stage.getHeight());
    ...
    private static void showMark(int i, int j, boolean win, boolean ultimate, boolean dark){
        ...
        Image mark;
        mark = !dark? win? getPlayer(ultimate)==1? p1Icon : p2Icon : dIcon : darkIcon;
        System.out.println("Mark set acc to player!");
        int width, height;
        width = height = ultimate? 50 : 100;
        ...
        if(dark)
            showMark(i,j,win,ultimate, false);
    }
